...
PYTHONUNBUFFERED=1 python -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=lhkhiem28/Qwen2.5-1.5B-GRPO-evo-0 \
...
python make_crossover.py --repo_id lhkhiem28/${experiment_name} --task "AMC12"
python make_crossover.py --repo_id lhkhiem28/${experiment_name} --task "OlympiadBench"
python make_crossover.py --repo_id lhkhiem28/${experiment_name} --task "AIME24"
python make_crossover.py --repo_id lhkhiem28/${experiment_name} --task "AIME25"
python make_crossover.py --repo_id lhkhiem28/${experiment_name} --task "Minerva"
python make_crossover.py --repo_id lhkhiem28/${experiment_name} --task "GPQA"
...
train_files="['../EvoGRPO-datasets/MATH/train_evo.parquet']"
val_files="['../EvoGRPO-datasets/MATH/test_evo.parquet']"
...
PYTHONUNBUFFERED=1 python -m verl.trainer.main_ppo \
    ...
    data.filter_overlong_prompts=True \
    data.truncation='error' \
    actor_rollout_ref.model.path=lhkhiem28/Qwen2.5-1.5B-GRPO-1 \
    actor_rollout_ref.model.use_remove_padding=True \
    actor_rollout_ref.model.enable_gradient_checkpointing=True \
    actor_rollout_ref.actor.optim.lr=1e-6 \
    actor_rollout_ref.actor.optim.lr_warmup_steps_ratio=0.1 \
...
PYTHONUNBUFFERED=1 python -m verl.model_merger merge \
    --backend fsdp \
    --local_dir checkpoints/${project_name}/${experiment_name}/global_step_29/actor \
    --target_dir checkpoints/${project_name}/${experiment_name}/global_step_29/actor/huggingface
python test.py --repo_id lhkhiem28/${experiment_name} --folder_path checkpoints/${project_name}/${experiment_name}/global_step_29/actor/huggingface
...
PYTHONUNBUFFERED=1 python -m verl.trainer.main_ppo \
    ...
    data.filter_overlong_prompts=True \
    data.truncation='error' \
    actor_rollout_ref.model.path=lhkhiem28/Qwen2.5-1.5B-GRPO-evo-1 \
    actor_rollout_ref.model.use_remove_padding=True \
    actor_rollout_ref.model.enable_gradient_checkpointing=True \
    actor_rollout_ref.actor.optim.lr=1e-6 \
    actor_rollout_ref.actor.optim.lr_warmup_steps_ratio=0.1 \
...
project_name="EvoGRPO"
experiment_name="Qwen2.5-1.5B-GRPO-evo-2"
...
PYTHONUNBUFFERED=1 python -m verl.trainer.main_ppo \
    ...
    data.filter_overlong_prompts=True \
    data.truncation='error' \
    actor_rollout_ref.model.path=lhkhiem28/Qwen2.5-1.5B-GRPO-2 \
    actor_rollout_ref.model.use_remove_padding=True \
    actor_rollout_ref.model.enable_gradient_checkpointing=True \
    actor_rollout_ref.actor.optim.lr=1e-6 \
    actor_rollout_ref.actor.optim.lr_warmup_steps_ratio=0.1 \
